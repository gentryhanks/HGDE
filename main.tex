...
%I put forth that, over time and place, different geographical locations within the body have come to be understood as the ``seat'' of the illness. 
\section{Background}
\doublespacing
...
\begin{figure}[H]
\centering
  \includegraphics [width=5in]{thanksgivinghavens.jpg}
...
\begin{figure}
\centering
  \includegraphics [width=5in]{thankshavep2.jpg}
...
\begin{figure}[H]
\centering
  \includegraphics [width=5.5in]{banting_fat.jpg}
...
\begin{figure}[H]
\centering
  \includegraphics [width=5in]{mental_man.jpg}
...
\begin{figure}[H]
\centering
  \includegraphics [width=5in]{mental_manp2.jpg}
...
\begin{figure}[H]
\centering
 \includegraphics [width=5.5in]{Dog_lab.png}
...
\begin{figure}[H]
\centering
 \includegraphics [width=5.5in]{Hughes_Chart.png}
...
%(add archival letter from dr to Banting about his female T1D patient struggling with weight gain)
...
% % 	Index Term(s): 	Insanity defense ; Diabetics ; Biological influences ; Criminal responsibility ; Great Britain/United Kingdom
